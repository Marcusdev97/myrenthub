document.addEventListener('DOMContentLoaded', () => {
  ...
  const openEditModal = async (id) => {
    try {
        ...
        // Populate form fields with the data retrieved
        ...
        // Populate the 'sources' select field
